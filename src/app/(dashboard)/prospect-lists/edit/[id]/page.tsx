        ...
        <Card>
          <CardContent className="p-6">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Failed to load lead list. Please try again.
              </AlertDescription>
            </Alert>
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Update the name and connected account for your lead list
        </p>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={formData.connectedAccountId || undefined}
                onValueChange={(value) => handleInputChange('connectedAccountId', value)}
              >
              ...
              {errors.connectedAccountId && (
                <p className="text-sm text-red-500">{errors.connectedAccountId}</p>
              )}
            </div>
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              ...
              <div className="text-sm space-y-1">
                <p><span className="font-medium">Total Leads:</span> {leadListData.leadList.total_leads || 0}</p>
                <p><span className="font-medium">Status:</span>
                  <Badge variant="outline" className="ml-2">
                    {leadListData.leadList.status}
                  </Badge>
                </p>
                <p><span className="font-medium">Source:</span> {leadListData.leadList.source}</p>
                <p><span className="font-medium">Created:</span> {leadListData.leadList.created_at ? new Date(leadListData.leadList.created_at).toLocaleDateString() : 'Unknown'}</p>
              </div>
            </div>
            ...
            <div className="flex justify-between pt-4">
              <Button
                type="button"
                variant="outline"
                onClick={() => router.push("/prospect-lists")}
              ...
              <Button
                type="submit"
                disabled={updateMutation.isPending || !formData.name.trim() || !formData.connectedAccountId}
