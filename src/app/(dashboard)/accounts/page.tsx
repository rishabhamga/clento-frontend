                  ...
                  <TableRow key={account.id} className="hover:bg-background/50">
                    ...
                    <TableCell>
                      <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-lg ${account.bgColor || 'bg-muted'}`}>
                          {account.id === 7 ? (
                            <IconComponent />
                          ) : (
                            <IconComponent className={`w-5 h-5 ${account.iconColor}`} />
                          )}
                        </div>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <span className="text-sm text-foreground">
                          {account.seatsTotal > 0 ? `${account.seatsUsed}/${account.seatsTotal} used` : '0/0 used'}
                        </span>
      ...
      <Dialog open={manageDialogOpen} onOpenChange={setManageDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              View and manage your connected LinkedIn accounts
            </DialogDescription>
          </DialogHeader>
