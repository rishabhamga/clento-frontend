        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage and monitor your outreach campaigns</p>
                </div>
                ...
                <CardContent>
                    {isLoading ? (
                        ...
                        <div className="text-center py-12">
                            <div className="text-muted-foreground mb-4">Oops no campaigns found, create one</div>
                            <Button className="bg-gradient-purple hover-glow-purple" onClick={() => router.push('/campaigns/create-campaign')}>
                                <Plus className="w-4 h-4 mr-2" />
                                    ...
                                    <TableRow key={campaign.id} className="hover:bg-background/50">
                                        <TableCell>
                                            <div>
                                                ...
                                                <div className="text-sm text-muted-foreground">Created {new Date(campaign.created_at).toLocaleDateString()}</div>
                                            </div>
                                        </TableCell>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-2 bg-muted rounded-md px-3 py-2 w-fit min-w-[160px]">
                                                {campaign.senderData?.profile_picture_url ? (
                                                    <img src={campaign.senderData.profile_picture_url} alt={campaign.senderData.name || 'Sender'} className="w-8 h-8 rounded-full object-cover border border-border" />
                                                ) : (
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="font-medium text-sm text-foreground">{campaign.senderData?.name || 'Unknown'}</span>
