    ...
    return (
        <header className="border-b border-border bg-card/50 backdrop-blur-sm">
            <div className="flex h-16 items-center justify-between px-6">
                ...
                <div className="flex items-center gap-4">{/* You can add your app logo here if needed */}</div>
                        ...
                        <OrganizationSwitcher
                            appearance={{
                                ...
                                elements: {
                                    ...
                                    organizationSwitcherTrigger: 'flex items-center gap-2 border border-border bg-background hover:bg-muted rounded-md px-3 py-2 text-sm min-w-[140px] justify-between text-foreground',
