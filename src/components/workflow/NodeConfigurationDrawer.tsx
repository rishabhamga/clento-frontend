...
const Toggle = ({
    ...
    return (
        <button
            ...
            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 ${checked ? 'bg-black' : 'bg-gray-200'
                }`}
        >
            <span
...
export const NodeConfigurationDrawer = ({
    isOpen,
    onClose,
    nodeData,
    nodeId,
    onConfigChange
}: NodeConfigurationDrawerProps) => {
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                        This is a simple action no configuration needed
                    </p>
                </div>
            </div>
        </div>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <Label htmlFor="number-of-posts" className="text-sm font-medium">Number of Posts</Label>
                <Input
                    id="number-of-posts"
                    type="number"
                    value={config.numberOfPosts || 1}
                    onChange={(e) => onConfigChange('numberOfPosts', parseInt(e.target.value) || 1)}
                    min="1"
                    max="10"
                    className="w-20"
                />
            ...
            <div className="flex items-center justify-between">
                <Label htmlFor="recent-post-days" className="text-sm font-medium">Recent Post Within (days)</Label>
                <Input
                    id="recent-post-days"
                    type="number"
                    value={config.recentPostDays || 7}
                    onChange={(e) => onConfigChange('recentPostDays', parseInt(e.target.value) || 7)}
                    min="1"
                    max="30"
                    className="w-20"
                />
            ...
            {config.configureWithAI && (
                <>
                    {/* Length Select */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="comment-length" className="text-sm font-medium">Comment Length</Label>
                        <Select
                            value={config.commentLength || 'medium'}
                            onValueChange={(value) => onConfigChange('commentLength', value)}
                        >
                    ...
                    {/* Tone */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="comment-tone" className="text-sm font-medium">Tone</Label>
                        <Select
                    ...
                    {/* Language */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="comment-language" className="text-sm font-medium">Language</Label>
                        <Select
            ...
            {config.configureWithAI ? (
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        placeholder="Enter any specific guidelines for comment generation..."
                ...
                <div className="space-y-2">
                    <Label htmlFor="custom-comment" className="text-sm font-medium">Custom Comment</Label>
                    <Textarea
                        id="custom-comment"
                        value={config.customComment || ''}
                        onChange={(e) => onConfigChange('customComment', e.target.value)}
                        placeholder="Type your comment here. Use variables like {{first_name}}, {{last_name}}, {{company}}..."
...
const ConnectionRequestConfiguration = ({
    config,
    onConfigChange
}: {
    config: BaseConfig
    ...
    return (
        <div className="space-y-6">
            {/* Can Use AI */}
            <div className="flex items-center justify-between">
                <Label htmlFor="can-use-ai" className="text-sm font-medium">Can Use AI</Label>
                <Toggle
                    id="can-use-ai"
                    checked={config.useAI || false}
                    onCheckedChange={(checked) => onConfigChange('useAI', checked)}
                />
            </div>
            ...
            {config.useAI && (
                <div className="space-y-4 border-t pt-4">
                    ...
                    {/* Tone */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="connection-tone" className="text-sm font-medium">Tone</Label>
                        <Select
                            value={config.tone || 'moderate'}
                            onValueChange={(value) => onConfigChange('tone', value)}
                        >
                            <SelectTrigger className="w-40">
                                <SelectValue placeholder="Select tone" />
                    ...
                    {/* Formality */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="connection-formality" className="text-sm font-medium">Formality</Label>
                        <Select
                            value={config.formality || 'approachable'}
                            onValueChange={(value) => onConfigChange('formality', value)}
                        >
                            <SelectTrigger className="w-40">
                    ...
                    {/* Approach */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="connection-approach" className="text-sm font-medium">Approach</Label>
                        <Select
                            value={config.approach || 'diplomatic'}
                            onValueChange={(value) => onConfigChange('approach', value)}
                        >
                            <SelectTrigger className="w-40">
                    ...
                    {/* Focus */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="connection-focus" className="text-sm font-medium">Focus</Label>
                        <Select
                            value={config.focus || 'relational'}
                            onValueChange={(value) => onConfigChange('focus', value)}
                        >
                            <SelectTrigger className="w-40">
                    ...
                    {/* Intention */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="connection-intention" className="text-sm font-medium">Intention</Label>
                        <Select
                            value={config.intention || 'networking'}
                            onValueChange={(value) => onConfigChange('intention', value)}
                        >
                            <SelectTrigger className="w-40">
                    ...
                    {/* Call-to-Action */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="connection-cta" className="text-sm font-medium">Call-to-Action</Label>
                        <Select
                            value={config.callToAction || 'confident'}
                            onValueChange={(value) => onConfigChange('callToAction', value)}
                        >
                            <SelectTrigger className="w-40">
                    ...
                    {/* Personalization */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="connection-personalization" className="text-sm font-medium">Personalization</Label>
                        <Select
                            value={config.personalization || 'specific'}
                            onValueChange={(value) => onConfigChange('personalization', value)}
                        >
                            <SelectTrigger className="w-40">
                    ...
                    {/* Language */}
                    <div className="flex items-center justify-between">
                        <Label htmlFor="connection-language" className="text-sm font-medium">Language</Label>
                        <Select
                            value={config.language || 'english'}
                            onValueChange={(value) => onConfigChange('language', value)}
                        >
            ...
            <Tooltip>
                <TooltipTrigger asChild>
                    <div className="flex items-center justify-between">
                        <Label htmlFor="engage-recent-activity" className="text-sm font-medium">Engage with recent activity?</Label>
                        <Toggle
                            id="engage-recent-activity"
                ...
                <TooltipContent
                    side="left"
                    className="bg-gradient-purple w-45"
                    arrowClassName="!bg-purple-600 !fill-purple-600"
                >
            ...
            {config.useAI ? (
                /* Custom Guidelines - shown when AI is enabled */
                <div className="space-y-2">
                    <Label htmlFor="connection-custom-guidelines" className="text-sm font-medium">Custom Guidelines</Label>
                    <Textarea
                        id="connection-custom-guidelines"
                        value={config.customGuidelines || ''}
                        onChange={(e) => onConfigChange('customGuidelines', e.target.value)}
                        placeholder="Enter any specific guidelines for connection requests..."
                        className="min-h-[80px] w-full"
                    />
                </div>
            ) : (
                ...
                <div className="space-y-2">
                    <Label htmlFor="custom-message" className="text-sm font-medium">Custom Connection Request Message</Label>
                    <Textarea
                        id="custom-message"
                        value={config.customMessage || ''}
                        onChange={(e) => onConfigChange('customMessage', e.target.value)}
                        placeholder="Type your connection request message here. Use variables like {{first_name}}, {{last_name}}, {{company}}..."
                        className="min-h-[100px] w-full"
                    />
                    <div className="text-xs text-gray-500 space-y-1">
                        <p className="font-medium">Available variables:</p>
...
const SendMessageConfiguration = ({
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="space-y-1">
                    <Label htmlFor="smart-followups" className="text-sm font-medium">Smart Followups</Label>
                    <p className="text-xs text-gray-500">Only go when the user hasn't replied yet</p>
                </div>
                <Toggle
                    id="smart-followups"
                    checked={config.smartFollowups || false}
                    onCheckedChange={(checked) => onConfigChange('smartFollowups', checked)}
                />
            </div>
...
const LikeConfiguration = ({
    ...
    return (
        <div className="space-y-6">
            {/* Number of Posts */}
            <div className="flex items-center justify-between">
                <Label htmlFor="like-number-of-posts" className="text-sm font-medium">Number of Posts</Label>
                <Input
                    id="like-number-of-posts"
                    type="number"
                    value={config.numberOfPosts || 1}
                    onChange={(e) => onConfigChange('numberOfPosts', parseInt(e.target.value) || 1)}
                    min="1"
            ...
            {/* Recent Post Within Days */}
            <div className="flex items-center justify-between">
                <Label htmlFor="like-recent-post-days" className="text-sm font-medium">Recent Post Within (days)</Label>
                <Input
                    id="like-recent-post-days"
                    type="number"
                    value={config.recentPostDays || 7}
                    onChange={(e) => onConfigChange('recentPostDays', parseInt(e.target.value) || 7)}
                    min="1"
