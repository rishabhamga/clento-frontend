                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2 bg-muted rounded-md px-3 py-2 w-fit min-w-[160px]">
                                        {campaign.sender_account_detail?.profile_picture_url ? (
                                            <img
                                                src={campaign.sender_account_detail.profile_picture_url}
                                                alt={campaign.sender_account_detail.name || "Sender"}
                                        ...
                                        <div className="flex flex-col">
                                            <span className="font-medium text-sm text-foreground">
                                                {campaign.sender_account_detail?.name || "Unknown"}
                                            </span>
                                            <span className="text-xs text-muted-foreground">
                                                {campaign.sender_account_detail?.provider || "No provider"}
                                            </span>
                                        </div>
                                    </div>
